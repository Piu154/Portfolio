      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        ...
        <div className="col-span-1 xl:row-span-3 rounded-lg" onMouseEnter={handleMouseEnter}
          ...
          <div className="grid-container grid_rspnsv">
            <img src="assets/grid1.png" alt="grid-1" className="w-full sm:h-[276px] h-fit object-contain" style={{ minHeight: '64%' }} />

            <div>
              <p className="grid-headtext grid-headtext_rspnsv">Hi, I’m Priya Samanta</p>
        ...
        <div className="col-span-1 xl:row-span-3 rounded-lg " onMouseEnter={handleMouseEnter}
          ...
          <div className="grid-container grid_rspnsv" >
            ...
            <div>
              <p className="grid-headtext grid-headtext_rspnsv mb-2">Tech Stack, Tools & Skills</p>
        ...
        <div className="col-span-1 xl:row-span-4 rounded-lg" onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}>
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext grid-headtext_rspnsv mb-2">I’m very flexible with time zone communications & locations</p>
              <p className="grid-subtext grid-headtext_rspnsvv">I&apos;m based in Kolkata, West Bengal and open to remote work worldwide.</p>
              <a href='#contact'>
